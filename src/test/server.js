...
export const startServer = () => {
  if (!apimocker) {
    ...
    apimocker.setRoutes({
      "/auditlog/publisher/v1/project/dev/viewertoken": {
        GET: {
          data: { token: "06b6b5fc7b314a289ca0031d26776b56" },
        },
      },
      "/auditlog/viewer/v1/viewersession": {
        POST: {
          data: {
            project_id: "dev",
            token:
    ...
    server.listen(3000, () => {
      console.log("API Mocker is running");
    });
  }
};
...
export const stopServer = async () => {
  if (apimocker) {
    await apimocker.stop();
    console.log("API Mocker stopped");
  }
};
